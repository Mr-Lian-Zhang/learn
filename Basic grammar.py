...
#TODO:知识点6：字典 key：value
massage={"姓名":"连志勇","年龄":"15","外貌":"帅气"}
#1.获取字典的value值
print(massage["姓名"])
#2.获取字典的长度
print(len(massage))
...
massage["身高"]="180"
print(massage)
#4.修改字典中的元素&没有key值的话则新增 有key值的话则修改
massage["年龄"]="25"
print(massage)
#5.删除字典中元素：随机删除：popitem
massage.popitem()
print(massage)
#6.删除字典中某个元素：删除指定的key：pop
massage.pop("年龄")
print(massage)
#7.获取字典中所有的key  value  item
print(massage.items())#输出元组形式
print(massage.keys())
print(massage.values())

#TODO:知识点7：元组
know=("连长","蛋蛋","老刁","秃头老吴",{"外貌":"很帅","体重":"120斤"})
#1.获取元组中某个元素
print(know[2])
#2.元组的修改 元组不可修改若元组里面的元素可修改才能修改可修改的元素例如：元组里面的列表 字典
know[4]["外貌"]="帅的掉渣"
print(know)
#3.若元组中只有一个元素 则不是元组
hha=(1)#不是元组
hha1=(1,)#是元组
#4.元组解包
dandan,lianzhang,laodiao=("贺创鑫","连志勇","老刁")#要一一对应
print(dandan)
print(lianzhang)

#TODO:知识点8：集合
gather={"贺创鑫","连志勇","王俊博","王浩","王贺选","王贺选"}#打印出是无序的
#去重
gather=set(["贺创鑫","连志勇","王俊博","王浩","王贺选","王贺选"])
print(gather)